...
- Preview: https://main--commerce-experiment2--chipolito1.hlx.page/
- Live: https://main--commerce-experiment2--chipolito1.hlx.live/
...
1. Open the `commerce-experiment2` directory in your favorite IDE and start coding :)
